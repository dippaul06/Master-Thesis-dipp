...
import system.Consumers.Consumer2;
import system.Disposable;
import system.SystemIO;
import system.SystemIO.Color;
import system.SystemIO.ConsoleOutput;
import system.SystemIO.Font;
...
import static utils.Contracts.checkNotNull;
import static utils.Contracts.checkState;
...
//
public enum Log implements Disposable {
    ...
    enum LogHandler implements Consumer2<String, Throwable> {
        ERROR {
            // Critical errors.
    ...
    static final class LogContext {
        ...
        LogContext(final String filePath) {
            ...
            if (filePath != null) {
                ...
                if (logFile.exists()) {
                    checkState(logFile.delete());
                }
                try {
                    checkState(logFile.createNewFile());
