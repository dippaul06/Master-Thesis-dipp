...
/**
 * Magma {@code byte} type companion.
 */
public enum I8 {
    ;
    /** Constant of the smallest representable value of {@code I8} type. */
    public static final byte MIN = Byte.MIN_VALUE + 1;

    /** Constant of the largest representable value of {@code I8} type. */
    public static final byte MAX = Byte.MAX_VALUE;

    /** Constant holding the » Not-a-Number (NaN) « value of {@code I8} type. */
    public static final byte NaN = Byte.MIN_VALUE;

    /** Determines whether the given value is the Not-a-Number (NaN) value. */
    public static boolean isNaN(final byte value) { return I8.NaN == value; }

    // ----------------------------------------------------------

    /// FUNCTION CONSTRUCTION.

    /// Factory methods to construct {@code byte} specialized functions
    /// from method references or lambda expressions see JLS §15.13, §15.27.

    /** Constructs a specialized {@code byte -> R} function. */
    public static <R> To<R> to(final To<R> fn) { return fn; }

    /** Constructs a specialized {@code byte -> byte} function. */
    public static ToI8 ToI8(final ToI8 fn) { return fn; }

    /** Constructs a specialized {@code byte -> short} function. */
    public static ToI16 ToI16(final ToI16 fn) { return fn; }

    /** Constructs a specialized {@code byte -> char} function. */
    public static ToC16 ToC16(final ToC16 fn) { return fn; }

    /** Constructs a specialized {@code byte -> int} function. */
    public static ToI32 ToI32(final ToI32 fn) { return fn; }

    /** Constructs a specialized {@code byte -> long} function. */
    public static ToI64 ToI64(final ToI64 fn) { return fn; }

    /** Constructs a specialized {@code byte -> float} function. */
    public static ToF32 ToF32(final ToF32 fn) { return fn; }

    /** Constructs a specialized {@code byte -> double} function. */
    public static ToF64 ToF64(final ToF64 fn) { return fn; }

    /** Constructs a specialized {@code byte} predicate. */
    public static Predicate Predicate(final Predicate pd) { return pd; }

    /** Constructs a specialized {@code byte} supplier. */
    public static Supplier Supplier(final Supplier sp) { return sp; }

    /** Constructs a specialized {@code byte} consumer. */
    ...
    /**
     * Function that takes no argument and returns a {@code byte} result.
     * <p>
     * Acts as a supplier of {@code byte} values, and makes no guarantees
     * for invocations returning a new or different result.
     */
    @FunctionalInterface
    public interface Supplier extends $Fn0<Byte> {
    ...
    /**
     * Consumer operation that takes a single {@code byte} argument
     * and returns no value. Consumer operates via side effects.
     */
    @FunctionalInterface
    public interface Consumer extends $Fn1<Byte, Unit> {

        /** The effect-less consumer. */
        Consumer empty = Const.empty;

        /**
         * Performs this operation with the given {@code byte} argument.
         *
         * @param val consumer argument.
         */
        void onAccept(byte val) throws Throwable;

        /**
         * Applies this consumer to the given {@code byte} argument.
         *
         * @param val consumer argument.
         */
        default void accept(final byte val) {
            try {
                onAccept(val);
            } catch (final Throwable ex) {
                Throw.sneaky(ex);
        ...
        enum Const implements Consumer {
            empty { public void onAccept(byte val) { } }
        }
    }
    ...
    /**
     * Predicate (boolean-valued function) that takes a single {@code byte} argument.
     */
    @FunctionalInterface
    public interface Predicate extends $Fn1<Byte, Boolean> {
        ...
        /**
         * Evaluates this predicate with the given {@code byte} argument.
         *
         * @param val predicate argument.
         * @return true iff this predicate is satisfied.
         * @throws Throwable permits any exception to be thrown.
         */
        boolean onEval(byte val) throws Throwable;

        /**
         * Applies this predicate to the given {@code byte} argument.
         *
         * @param val predicate argument.
         * @return true iff this predicate is satisfied.
         */
        default boolean eval(final byte val) {
            try {
                return onEval(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
        ...
        enum Const implements Predicate {
            True  { public boolean onEval(byte __) { return true;  } },
            False { public boolean onEval(byte __) { return false; } }
        }
    }
    ...
    /**
     * Function that takes a single {@code byte} argument
     * and returns a result of type {@code R}.
     *
     * @param <R> type of function result.
     */
    @FunctionalInterface
    public interface To<R> extends $Fn1<Byte, R> {

        /**
         * Invokes this function with the given {@code byte} argument.
         *
         * @param val function argument.
         * @return result of type {@code R}.
         * @throws Throwable permits any exception to be thrown.
         */
        R onApply(byte val) throws Throwable;

        /**
         * Applies this function to the given {@code byte} argument.
         *
         * @param val function argument.
         * @return result of type {@code R}.
         */
        default R apply(final byte val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToBool extends $Fn1<Byte, Boolean> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        boolean onApply(byte val) throws Throwable;
         ...
         * @return {@code boolean} result.
         */
        default boolean apply(final byte val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToI8 extends $Fn1<Byte, Byte> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        byte onApply(byte val) throws Throwable;
         ...
         * @return {@code byte} result.
         */
        default byte apply(final byte val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToI16 extends $Fn1<Byte, Short> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        short onApply(byte val) throws Throwable;
         ...
         * @return {@code short} result.
         */
        default short apply(final byte val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToC16 extends $Fn1<Byte, Character> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        char onApply(byte val) throws Throwable;
         ...
         * @return {@code char} result.
         */
        default char apply(final byte val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToI32 extends $Fn1<Byte, Integer> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        int onApply(byte val) throws Throwable;
         ...
         * @return {@code int} result.
         */
        default int apply(final byte val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToI64 extends $Fn1<Byte, Long> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        long onApply(byte val) throws Throwable;
         ...
         * @return {@code long} result.
         */
        default long apply(final byte val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToF32 extends $Fn1<Byte, Float> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        float onApply(byte val) throws Throwable;
         ...
         * @return {@code float} result.
         */
        default float apply(final byte val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToF64 extends $Fn1<Byte, Double> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        double onApply(byte val) throws Throwable;
         ...
         * @return {@code double} result.
         */
        default double apply(final byte val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    public interface Traverser extends ITraverser<Byte, Consumer> {

        // ----------------------------------------------------------
        //  I8.TRAVERSER.INDEXED
        // ----------------------------------------------------------
         ...
         */
        interface Indexed extends ITraverser.Indexed<Byte, Consumer>, Traverser {
         ...
         */
        interface Duplex extends ITraverser.Duplex<Byte, Consumer>, Traverser {

            // ----------------------------------------------------------
            //  I8.TRAVERSER.DUPLEX.INDEXED
            // ----------------------------------------------------------
             ...
             */
            interface Indexed extends ITraverser.Duplex.Indexed<Byte, Consumer>,
        ...
        default java.util.Iterator<Byte> iterator() {
            ...
            final class It implements java.util.Iterator<Byte>, Consumer {
                private Byte next;
                @Override public boolean hasNext() { return tryNext(this); }
                @Override public Byte next() { return next; }
                @Override public void onAccept(final byte next) {
                    this.next = next;
                }
            }
            return new It();
    ...
    */
    public interface Traversable extends Iterable<Byte>, ITraversable<Consumer> {
     ...
     */
    public interface Flow<U extends IFlow<?, U>> extends IFlow<Byte, U>,

            Traversable,

            // ----------------------------------------------------------

            Operation.Query.Membership.OfI8<U>,

            Operation.Query.Quantify.OfI8<U>,

            // ----------------------------------------------------------

            Operation.Fold.FoldLeft.OfI8<U>,

            Operation.Fold.Collect.OfI8<U>,

            // ----------------------------------------------------------

            Operation.Convert.ToArray.OfI8<U>,

            Operation.Convert.ToCollection.OfI8<U>
    {
        /**
         ...
         */
        @Override
        default boolean contains(final byte val) {
         ...
         * the given predicate over the values {@code '∃(x) ∈ Flow.OfI8 P(x)'}.
         ...
         * of the predicate over the values {@code '∀(x) ∈ Flow.OfI8 P(x)'}.
         * The predicate is not evaluated for all values if it is not required
         ...
         * the negated predicate over the array {@code '∀(x) ∈ Flow.OfI8 ¬P(x)'}.
         * The predicate is not evaluated for all values if it is not required
         * to determine the result. If no values are present, the quantification
         * is said to be 'vacuously satisfied', and always true is returned,
         * independent of P(x).
        ...
        default <Z> Z foldLeft(final Z initial, final Fn1<Z, To<Z>> combiner) {
            ...
            final class Fold implements Consumer {
                ...
                @Override
                public void onAccept(final byte value) throws Throwable {
        ...
        interface Producer<U extends IProducer<?, U>> extends Flow<U>,
                ...
                Transform.Peek.OfI8<U>,

                Transform.Filter.OfI8<U>,

                // ----------------------------------------------------------

                Transmute.Map.OfI8<U>,

                Transmute.FlatMap.OfI8<U> {
        }
    }
     ...
     */
    public static Option some(final byte value) {
     ...
     * @return optional value.
     */
    public static Option when(final boolean condition, final byte value) {
     ...
     */
    public interface Option extends IOption<Byte>,

            Operation.Access.Value.OfI8<IOption<?>>,

            Operation.Transmute.PolyMap.OfI8<IOption<?>>,

            Operation.Transmute.PolyFlatMap.OfI8<IOption<?>>,
            ...
            Flow.Producer<IOption<?>>
    {
         ...
         * @return match result.
         */
        <R> R match(Fn1<? super Byte, ? extends R> some,
                    Fn0<? extends R> none);
         ...
         */
        <X extends Throwable> byte orElseThrow(magma.exa.value.Lazy<? extends X> exception) throws X;
        ...
        final class Some implements Option {
             ...
             */
            @Override
            public <R> R match(final Fn1<? super Byte, ? extends R> some,
             ...
             */
            @Override
            public byte orElse(final Supplier other) {
             ...
             */
            @Override
            public <X extends Throwable> byte orElseThrow(final magma.exa.value.Lazy<? extends X> exception) {
        ...
        enum None implements Option {
             ...
             */
            @Override
            public <X extends Throwable> byte orElseThrow(final magma.exa.value.Lazy<? extends X> exception) throws X {
    ...
    /**
     * A lazy evaluated {@code byte} value.
     */
    public interface Lazy extends Supplier {
        ...
        static Lazy of(final Supplier thunk) {
            ...
            final class LazyBox implements Lazy {
                ...
                private byte value;
                @Override
                public byte onApply() throws Throwable {
                    if (!initialized) {
                        synchronized (this) {
                            if (!initialized) {
                                value = thunk.apply();
    ...
    public enum Relation implements To<Predicate> {
        EQ { @Override public Predicate onApply(final byte val) { return x -> x == val; } },
        NE { @Override public Predicate onApply(final byte val) { return x -> x != val; } },
        GT { @Override public Predicate onApply(final byte val) { return x -> x >  val; } },
        GE { @Override public Predicate onApply(final byte val) { return x -> x >= val; } },
        LT { @Override public Predicate onApply(final byte val) { return x -> x <  val; } },
        LE { @Override public Predicate onApply(final byte val) { return x -> x <= val; } }
    }


    // ----------------------------------------------------------

    public static Predicate equal        (final byte val) { return Relation.EQ.apply(val); }
    public static Predicate notEqual     (final byte val) { return Relation.NE.apply(val); }
    public static Predicate greaterThan  (final byte val) { return Relation.GT.apply(val); }
    public static Predicate greaterEqual (final byte val) { return Relation.GE.apply(val); }
    public static Predicate lessThan     (final byte val) { return Relation.LT.apply(val); }
    public static Predicate lessEqual    (final byte val) { return Relation.LE.apply(val); }

    // ----------------------------------------------------------

    public static Predicate any(final byte... ary) {
        return (ary.length != 0) ? x -> Array.anyMatch(ary, equal(x)) : Predicate.False;
    }
    public static Predicate all(final byte... ary) {
