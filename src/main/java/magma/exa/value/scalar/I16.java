...
/**
 * Magma {@code short} type companion.
 */
public enum I16 {
    ;
    /** Constant of the smallest representable value of {@code I16} type. */
    public static final short MIN = Short.MIN_VALUE + 1;

    /** Constant of the largest representable value of {@code I16} type. */
    public static final short MAX = Short.MAX_VALUE;

    /** Constant holding the » Not-a-Number (NaN) « value of {@code I16} type. */
    public static final short NaN = Short.MIN_VALUE;

    /** Determines whether the given value is the Not-a-Number (NaN) value. */
    public static boolean isNaN(final short value) { return I16.NaN == value; }

    // ----------------------------------------------------------

    /// FUNCTION CONSTRUCTION.

    /// Factory methods to construct {@code short} specialized functions
    /// from method references or lambda expressions see JLS §15.13, §15.27.

    /** Constructs a specialized {@code short -> R} function. */
    public static <R> To<R> to(final To<R> fn) { return fn; }

    /** Constructs a specialized {@code short -> byte} function. */
    public static ToI8 ToI8(final ToI8 fn) { return fn; }

    /** Constructs a specialized {@code short -> short} function. */
    public static ToI16 ToI16(final ToI16 fn) { return fn; }

    /** Constructs a specialized {@code short -> char} function. */
    public static ToC16 ToC16(final ToC16 fn) { return fn; }

    /** Constructs a specialized {@code short -> int} function. */
    public static ToI32 ToI32(final ToI32 fn) { return fn; }

    /** Constructs a specialized {@code short -> long} function. */
    public static ToI64 ToI64(final ToI64 fn) { return fn; }

    /** Constructs a specialized {@code short -> float} function. */
    public static ToF32 ToF32(final ToF32 fn) { return fn; }

    /** Constructs a specialized {@code short -> double} function. */
    public static ToF64 ToF64(final ToF64 fn) { return fn; }

    /** Constructs a specialized {@code short} predicate. */
    public static Predicate Predicate(final Predicate pd) { return pd; }

    /** Constructs a specialized {@code short} supplier. */
    public static Supplier Supplier(final Supplier sp) { return sp; }

    /** Constructs a specialized {@code short} consumer. */
    ...
    /**
     * Function that takes no argument and returns a {@code short} result.
     * <p>
     * Acts as a supplier of {@code short} values, and makes no guarantees
     * for invocations returning a new or different result.
     */
    @FunctionalInterface
    public interface Supplier extends $Fn0<Short> {
         ...
         */
        short onApply() throws Throwable;
    ...
    /**
     * Consumer operation that takes a single {@code short} argument
     * and returns no value. Consumer operates via side effects.
     */
    @FunctionalInterface
    public interface Consumer extends $Fn1<Short, Unit> {

        /** The effect-less consumer. */
        Consumer empty = Const.empty;

        /**
         * Performs this operation with the given {@code short} argument.
         *
         * @param val consumer argument.
         */
        void onAccept(short val) throws Throwable;

        /**
         * Applies this consumer to the given {@code short} argument.
         *
         * @param val consumer argument.
         */
        default void accept(final short val) {
            try {
                onAccept(val);
            } catch (final Throwable ex) {
                Throw.sneaky(ex);
        ...
        enum Const implements Consumer {
            empty { public void onAccept(short val) { } }
        }
    }
    ...
    /**
     * Predicate (boolean-valued function) that takes a single {@code short} argument.
     */
    @FunctionalInterface
    public interface Predicate extends $Fn1<Short, Boolean> {
        ...
        /**
         * Evaluates this predicate with the given {@code short} argument.
         *
         * @param val predicate argument.
         * @return true iff this predicate is satisfied.
         * @throws Throwable permits any exception to be thrown.
         */
        boolean onEval(short val) throws Throwable;

        /**
         * Applies this predicate to the given {@code short} argument.
         *
         * @param val predicate argument.
         * @return true iff this predicate is satisfied.
         */
        default boolean eval(final short val) {
            try {
                return onEval(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
        ...
        enum Const implements Predicate {
            True  { public boolean onEval(short __) { return true;  } },
            False { public boolean onEval(short __) { return false; } }
        }
    }
    ...
    /**
     * Function that takes a single {@code short} argument
     * and returns a result of type {@code R}.
     *
     * @param <R> type of function result.
     */
    @FunctionalInterface
    public interface To<R> extends $Fn1<Short, R> {

        /**
         * Invokes this function with the given {@code short} argument.
         *
         * @param val function argument.
         * @return result of type {@code R}.
         * @throws Throwable permits any exception to be thrown.
         */
        R onApply(short val) throws Throwable;

        /**
         * Applies this function to the given {@code short} argument.
         *
         * @param val function argument.
         * @return result of type {@code R}.
         */
        default R apply(final short val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToBool extends $Fn1<Short, Boolean> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        boolean onApply(short val) throws Throwable;
         ...
         * @return {@code boolean} result.
         */
        default boolean apply(final short val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToI8 extends $Fn1<Short, Byte> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        byte onApply(short val) throws Throwable;
         ...
         * @return {@code byte} result.
         */
        default byte apply(final short val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToI16 extends $Fn1<Short, Short> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        short onApply(short val) throws Throwable;
         ...
         * @return {@code short} result.
         */
        default short apply(final short val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToC16 extends $Fn1<Short, Character> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        char onApply(short val) throws Throwable;
         ...
         * @return {@code char} result.
         */
        default char apply(final short val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToI32 extends $Fn1<Short, Integer> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        int onApply(short val) throws Throwable;
         ...
         * @return {@code int} result.
         */
        default int apply(final short val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToI64 extends $Fn1<Short, Long> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        long onApply(short val) throws Throwable;
         ...
         * @return {@code long} result.
         */
        default long apply(final short val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToF32 extends $Fn1<Short, Float> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        float onApply(short val) throws Throwable;
         ...
         * @return {@code float} result.
         */
        default float apply(final short val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToF64 extends $Fn1<Short, Double> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        double onApply(short val) throws Throwable;
         ...
         * @return {@code double} result.
         */
        default double apply(final short val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    public interface Traverser extends ITraverser<Short, Consumer> {

        // ----------------------------------------------------------
        //  I16.TRAVERSER.INDEXED
        // ----------------------------------------------------------
         ...
         */
        interface Indexed extends ITraverser.Indexed<Short, Consumer>, Traverser {
         ...
         */
        interface Duplex extends ITraverser.Duplex<Short, Consumer>, Traverser {

            // ----------------------------------------------------------
            //  I16.TRAVERSER.DUPLEX.INDEXED
            // ----------------------------------------------------------
             ...
             */
            interface Indexed extends ITraverser.Duplex.Indexed<Short, Consumer>,
         ...
         */
        @Override
        default java.util.Iterator<Short> iterator() {
            // Weak iterator contract...
            final class It implements java.util.Iterator<Short>, Consumer {
                private Short next;
                @Override public boolean hasNext() { return tryNext(this); }
                @Override public Short next() { return next; }
                @Override public void onAccept(final short next) {
                    this.next = next;
                }
            }
            return new It();
    ...
    */
    public interface Traversable extends Iterable<Short>, ITraversable<Consumer> {
     ...
     */
    public interface Flow<U extends IFlow<?, U>> extends IFlow<Short, U>,

            Traversable,

            // ----------------------------------------------------------

            Operation.Query.Membership.OfI16<U>,

            Operation.Query.Quantify.OfI16<U>,

            // ----------------------------------------------------------

            Operation.Fold.FoldLeft.OfI16<U>,

            Operation.Fold.Collect.OfI16<U>,

            // ----------------------------------------------------------

            Operation.Convert.ToArray.OfI16<U>,

            Operation.Convert.ToCollection.OfI16<U>
    {
        /**
         ...
         */
        @Override
        default boolean contains(final short val) {
         ...
         * the given predicate over the values {@code '∃(x) ∈ Flow.OfI16 P(x)'}.
         ...
         * of the predicate over the values {@code '∀(x) ∈ Flow.OfI16 P(x)'}.
         * The predicate is not evaluated for all values if it is not required
         ...
         * the negated predicate over the array {@code '∀(x) ∈ Flow.OfI16 ¬P(x)'}.
         * The predicate is not evaluated for all values if it is not required
         * to determine the result. If no values are present, the quantification
         * is said to be 'vacuously satisfied', and always true is returned,
         * independent of P(x).
        ...
        default <Z> Z foldLeft(final Z initial, final Fn1<Z, To<Z>> combiner) {
            ...
            final class Fold implements Consumer {
                ...
                @Override
                public void onAccept(final short value) throws Throwable {
        ...
        interface Producer<U extends IProducer<?, U>> extends Flow<U>,
                ...
                Transform.Peek.OfI16<U>,

                Transform.Filter.OfI16<U>,

                // ----------------------------------------------------------

                Transmute.Map.OfI16<U>,

                Transmute.FlatMap.OfI16<U> {
        }
    }
     ...
     */
    public static Option some(final short value) {
     ...
     * @return optional value.
     */
    public static Option when(final boolean condition, final short value) {
     ...
     */
    public interface Option extends IOption<Short>,

            Operation.Access.Value.OfI16<IOption<?>>,

            Operation.Transmute.PolyMap.OfI16<IOption<?>>,

            Operation.Transmute.PolyFlatMap.OfI16<IOption<?>>,
            ...
            Flow.Producer<IOption<?>>
    {
         ...
         * @return match result.
         */
        <R> R match(Fn1<? super Short, ? extends R> some,
                    Fn0<? extends R> none);
         ...
         * Returns either some present value or throws an exception.
         */
        default short get() { return value(); }
         ...
         */
        <X extends Throwable> short orElseThrow(magma.exa.value.Lazy<? extends X> exception) throws X;
        ...
        final class Some implements Option {
             ...
             */
            @Override
            public <R> R match(final Fn1<? super Short, ? extends R> some,
             ...
             */
            @Override
            public short orElse(final Supplier other) {
             ...
             */
            @Override
            public <X extends Throwable> short orElseThrow(final magma.exa.value.Lazy<? extends X> exception) {
        ...
        enum None implements Option {
             ...
             */
            @Override
            public <X extends Throwable> short orElseThrow(final magma.exa.value.Lazy<? extends X> exception) throws X {
    ...
    /**
     * A lazy evaluated {@code short} value.
     */
    public interface Lazy extends Supplier {
        ...
        static Lazy of(final Supplier thunk) {
            ...
            final class LazyBox implements Lazy {
                ...
                private short value;
                @Override
                public short onApply() throws Throwable {
                    if (!initialized) {
                        synchronized (this) {
                            if (!initialized) {
                                value = thunk.apply();
    ...
    public enum Relation implements To<Predicate> {
        EQ { @Override public Predicate onApply(final short val) { return x -> x == val; } },
        NE { @Override public Predicate onApply(final short val) { return x -> x != val; } },
        GT { @Override public Predicate onApply(final short val) { return x -> x >  val; } },
        GE { @Override public Predicate onApply(final short val) { return x -> x >= val; } },
        LT { @Override public Predicate onApply(final short val) { return x -> x <  val; } },
        LE { @Override public Predicate onApply(final short val) { return x -> x <= val; } }
    }


    // ----------------------------------------------------------

    public static Predicate equal        (final short val) { return Relation.EQ.apply(val); }
    public static Predicate notEqual     (final short val) { return Relation.NE.apply(val); }
    public static Predicate greaterThan  (final short val) { return Relation.GT.apply(val); }
    public static Predicate greaterEqual (final short val) { return Relation.GE.apply(val); }
    public static Predicate lessThan     (final short val) { return Relation.LT.apply(val); }
    public static Predicate lessEqual    (final short val) { return Relation.LE.apply(val); }

    // ----------------------------------------------------------

    public static Predicate any(final short... ary) {
        return (ary.length != 0) ? x -> Array.anyMatch(ary, equal(x)) : Predicate.False;
    }
    public static Predicate all(final short... ary) {
