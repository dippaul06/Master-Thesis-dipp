...
/**
 * Magma {@code double} type companion.
 */
public enum F64 {
    ;
    /** Constant of the smallest representable value of {@code F64} type. */
    public static final double MIN = Double.MIN_VALUE + 1;

    /** Constant of the largest representable value of {@code F64} type. */
    public static final double MAX = Double.MAX_VALUE;

    /** Constant holding the » Not-a-Number (NaN) « value of {@code F64} type. */
    public static final double NaN = Double.MIN_VALUE;

    /** Determines whether the given value is the Not-a-Number (NaN) value. */
    public static boolean isNaN(final double value) { return F64.NaN == value; }

    // ----------------------------------------------------------

    /// FUNCTION CONSTRUCTION.

    /// Factory methods to construct {@code double} specialized functions
    /// from method references or lambda expressions see JLS §15.13, §15.27.

    /** Constructs a specialized {@code double -> R} function. */
    public static <R> To<R> to(final To<R> fn) { return fn; }

    /** Constructs a specialized {@code double -> byte} function. */
    public static ToI8 ToI8(final ToI8 fn) { return fn; }

    /** Constructs a specialized {@code double -> short} function. */
    public static ToI16 ToI16(final ToI16 fn) { return fn; }

    /** Constructs a specialized {@code double -> char} function. */
    public static ToC16 ToC16(final ToC16 fn) { return fn; }

    /** Constructs a specialized {@code double -> int} function. */
    public static ToI32 ToI32(final ToI32 fn) { return fn; }

    /** Constructs a specialized {@code double -> long} function. */
    public static ToI64 ToI64(final ToI64 fn) { return fn; }

    /** Constructs a specialized {@code double -> float} function. */
    public static ToF32 ToF32(final ToF32 fn) { return fn; }

    /** Constructs a specialized {@code double -> double} function. */
    public static ToF64 ToF64(final ToF64 fn) { return fn; }

    /** Constructs a specialized {@code double} predicate. */
    public static Predicate Predicate(final Predicate pd) { return pd; }

    /** Constructs a specialized {@code double} supplier. */
    public static Supplier Supplier(final Supplier sp) { return sp; }

    /** Constructs a specialized {@code double} consumer. */
    ...
    /**
     * Function that takes no argument and returns a {@code double} result.
     * <p>
     * Acts as a supplier of {@code double} values, and makes no guarantees
     * for invocations returning a new or different result.
     */
    @FunctionalInterface
    public interface Supplier extends $Fn0<Double> {
         ...
         */
        double onApply() throws Throwable;
    ...
    /**
     * Consumer operation that takes a single {@code double} argument
     * and returns no value. Consumer operates via side effects.
     */
    @FunctionalInterface
    public interface Consumer extends $Fn1<Double, Unit> {

        /** The effect-less consumer. */
        Consumer empty = Const.empty;

        /**
         * Performs this operation with the given {@code double} argument.
         *
         * @param val consumer argument.
         */
        void onAccept(double val) throws Throwable;

        /**
         * Applies this consumer to the given {@code double} argument.
         *
         * @param val consumer argument.
         */
        default void accept(final double val) {
            try {
                onAccept(val);
            } catch (final Throwable ex) {
                Throw.sneaky(ex);
        ...
        enum Const implements Consumer {
            empty { public void onAccept(double val) { } }
        }
    }
    ...
    /**
     * Predicate (boolean-valued function) that takes a single {@code double} argument.
     */
    @FunctionalInterface
    public interface Predicate extends $Fn1<Double, Boolean> {
        ...
        /**
         * Evaluates this predicate with the given {@code double} argument.
         *
         * @param val predicate argument.
         * @return true iff this predicate is satisfied.
         * @throws Throwable permits any exception to be thrown.
         */
        boolean onEval(double val) throws Throwable;

        /**
         * Applies this predicate to the given {@code double} argument.
         *
         * @param val predicate argument.
         * @return true iff this predicate is satisfied.
         */
        default boolean eval(final double val) {
            try {
                return onEval(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
        ...
        enum Const implements Predicate {
            True  { public boolean onEval(double __) { return true;  } },
            False { public boolean onEval(double __) { return false; } }
        }
    }
    ...
    /**
     * Function that takes a single {@code double} argument
     * and returns a result of type {@code R}.
     *
     * @param <R> type of function result.
     */
    @FunctionalInterface
    public interface To<R> extends $Fn1<Double, R> {

        /**
         * Invokes this function with the given {@code double} argument.
         *
         * @param val function argument.
         * @return result of type {@code R}.
         * @throws Throwable permits any exception to be thrown.
         */
        R onApply(double val) throws Throwable;

        /**
         * Applies this function to the given {@code double} argument.
         *
         * @param val function argument.
         * @return result of type {@code R}.
         */
        default R apply(final double val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToBool extends $Fn1<Double, Boolean> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        boolean onApply(double val) throws Throwable;
         ...
         * @return {@code boolean} result.
         */
        default boolean apply(final double val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToI8 extends $Fn1<Double, Byte> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        byte onApply(double val) throws Throwable;
         ...
         * @return {@code byte} result.
         */
        default byte apply(final double val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToI16 extends $Fn1<Double, Short> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        short onApply(double val) throws Throwable;
         ...
         * @return {@code short} result.
         */
        default short apply(final double val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToC16 extends $Fn1<Double, Character> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        char onApply(double val) throws Throwable;
         ...
         * @return {@code char} result.
         */
        default char apply(final double val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToI32 extends $Fn1<Double, Integer> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        int onApply(double val) throws Throwable;
         ...
         * @return {@code int} result.
         */
        default int apply(final double val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToI64 extends $Fn1<Double, Long> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        long onApply(double val) throws Throwable;
         ...
         * @return {@code long} result.
         */
        default long apply(final double val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToF32 extends $Fn1<Double, Float> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        float onApply(double val) throws Throwable;
         ...
         * @return {@code float} result.
         */
        default float apply(final double val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToF64 extends $Fn1<Double, Double> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        double onApply(double val) throws Throwable;
         ...
         * @return {@code double} result.
         */
        default double apply(final double val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    public interface Traverser extends ITraverser<Double, Consumer> {

        // ----------------------------------------------------------
        //  F64.TRAVERSER.INDEXED
        // ----------------------------------------------------------
         ...
         */
        interface Indexed extends ITraverser.Indexed<Double, Consumer>, Traverser {
         ...
         */
        interface Duplex extends ITraverser.Duplex<Double, Consumer>, Traverser {

            // ----------------------------------------------------------
            //  F64.TRAVERSER.DUPLEX.INDEXED
            // ----------------------------------------------------------
             ...
             */
            interface Indexed extends ITraverser.Duplex.Indexed<Double, Consumer>,
         ...
         */
        @Override
        default java.util.Iterator<Double> iterator() {
            // Weak iterator contract...
            final class It implements java.util.Iterator<Double>, Consumer {
                private Double next;
                @Override public boolean hasNext() { return tryNext(this); }
                @Override public Double next() { return next; }
                @Override public void onAccept(final double next) {
                    this.next = next;
                }
            }
            return new It();
    ...
    */
    public interface Traversable extends Iterable<Double>, ITraversable<Consumer> {
     ...
     */
    public interface Flow<U extends IFlow<?, U>> extends IFlow<Double, U>,

            Traversable,

            // ----------------------------------------------------------

            Operation.Query.Membership.OfF64<U>,

            Operation.Query.Quantify.OfF64<U>,

            // ----------------------------------------------------------

            Operation.Fold.FoldLeft.OfF64<U>,

            Operation.Fold.Collect.OfF64<U>,

            // ----------------------------------------------------------

            Operation.Convert.ToArray.OfF64<U>,

            Operation.Convert.ToCollection.OfF64<U>
    {
        /**
         ...
         */
        @Override
        default boolean contains(final double val) {
         ...
         * the given predicate over the values {@code '∃(x) ∈ Flow.OfF64 P(x)'}.
         ...
         * of the predicate over the values {@code '∀(x) ∈ Flow.OfF64 P(x)'}.
         * The predicate is not evaluated for all values if it is not required
         ...
         * the negated predicate over the array {@code '∀(x) ∈ Flow.OfF64 ¬P(x)'}.
         * The predicate is not evaluated for all values if it is not required
         * to determine the result. If no values are present, the quantification
         * is said to be 'vacuously satisfied', and always true is returned,
         * independent of P(x).
        ...
        default <Z> Z foldLeft(final Z initial, final Fn1<Z, To<Z>> combiner) {
            ...
            final class Fold implements Consumer {
                ...
                @Override
                public void onAccept(final double value) throws Throwable {
        ...
        interface Producer<U extends IProducer<?, U>> extends Flow<U>,
                ...
                Transform.Peek.OfF64<U>,

                Transform.Filter.OfF64<U>,

                // ----------------------------------------------------------

                Transmute.Map.OfF64<U>,

                Transmute.FlatMap.OfF64<U> {
        }
    }
     ...
     */
    public static Option some(final double value) {
     ...
     * @return optional value.
     */
    public static Option when(final boolean condition, final double value) {
     ...
     */
    public interface Option extends IOption<Double>,

            Operation.Access.Value.OfF64<IOption<?>>,

            Operation.Transmute.PolyMap.OfF64<IOption<?>>,

            Operation.Transmute.PolyFlatMap.OfF64<IOption<?>>,
            ...
            Flow.Producer<IOption<?>>
    {
         ...
         * @return match result.
         */
        <R> R match(Fn1<? super Double, ? extends R> some,
                    Fn0<? extends R> none);
         ...
         * @return optional {@code double}.
         */
        Option flatMapF64(To<? extends Iterable<Double>> mapper);
         ...
         * Returns either some present value or throws an exception.
         */
        default double get() { return value(); }
         ...
         */
        <X extends Throwable> double orElseThrow(magma.exa.value.Lazy<? extends X> exception) throws X;
        ...
        final class Some implements Option {
             ...
             */
            @Override
            public <R> R match(final Fn1<? super Double, ? extends R> some,
             ...
             */
            @Override
            public double orElse(final Supplier other) {
             ...
             */
            @Override
            public <X extends Throwable> double orElseThrow(final magma.exa.value.Lazy<? extends X> exception) {
             ...
             */
            @Override
            public Option mapF64(final ToF64 mapper) {
             ...
             */
            @Override
            public Option flatMapF64(final To<? extends Iterable<Double>> mapper) {
                final var itr = mapper.apply(value);
                // Strict defensive on data being passed.
                if (null != itr) {
                    final var it = itr.iterator();
        ...
        enum None implements Option {
             ...
             */
            @Override
            public <X extends Throwable> double orElseThrow(final magma.exa.value.Lazy<? extends X> exception) throws X {
    ...
    /**
     * A lazy evaluated {@code double} value.
     */
    public interface Lazy extends Supplier {
        ...
        static Lazy of(final Supplier thunk) {
            ...
            final class LazyBox implements Lazy {
                ...
                @Override
                public double onApply() throws Throwable {
                    if (!initialized) {
                        synchronized (this) {
                            if (!initialized) {
                                value = thunk.apply();
    ...
    public enum Relation implements To<Predicate> {
        EQ { @Override public Predicate onApply(final double val) { return x -> x == val; } },
        NE { @Override public Predicate onApply(final double val) { return x -> x != val; } },
        GT { @Override public Predicate onApply(final double val) { return x -> x >  val; } },
        GE { @Override public Predicate onApply(final double val) { return x -> x >= val; } },
        LT { @Override public Predicate onApply(final double val) { return x -> x <  val; } },
        LE { @Override public Predicate onApply(final double val) { return x -> x <= val; } }
    }


    // ----------------------------------------------------------

    public static Predicate equal        (final double val) { return Relation.EQ.apply(val); }
    public static Predicate notEqual     (final double val) { return Relation.NE.apply(val); }
    public static Predicate greaterThan  (final double val) { return Relation.GT.apply(val); }
    public static Predicate greaterEqual (final double val) { return Relation.GE.apply(val); }
    public static Predicate lessThan     (final double val) { return Relation.LT.apply(val); }
    public static Predicate lessEqual    (final double val) { return Relation.LE.apply(val); }

    // ----------------------------------------------------------

    public static Predicate any(final double... ary) {
        return (ary.length != 0) ? x -> Array.anyMatch(ary, equal(x)) : Predicate.False;
    }
    public static Predicate all(final double... ary) {
