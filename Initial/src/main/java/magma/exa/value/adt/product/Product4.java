...
import magma.exa.value.adt.compound.Compound4;

/**
 * Generalized product of 4 heterogeneous types.
 *
 ...
 */
public interface Product4<A, B, C, D> extends Product<$4>,
        Compound4<$4, A, B, C, D> {
     ...
     */
    default <R> R match(final Fn4<? super A, ? super B, ? super C, ? super D, ? extends R> function) {
        return function.apply(_1(), _2(), _3(), _4());
    }

    // ----------------------------------------------------------
    //  PRODUCT-4.ASSIGNABLE
    // ----------------------------------------------------------

    /**
     * Assignable form of {@link Product4}.
     *
     * @param <A> type of the 1st slot.
     * @param <B> type of the 2nd slot.
     * @param <C> type of the 3rd slot.
     ...
     */
    interface Assignable<A, B, C, D, U extends Assignable<A, B, C, D, ?>>
            extends Product4<A, B, C, D>, Compound4.Assignable<A, B, C, D, U> {
    }
}
