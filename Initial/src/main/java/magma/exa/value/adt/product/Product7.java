...
import magma.exa.value.adt.compound.Compound7;

/**
 * Generalized product of 7 heterogeneous types.
 *
 ...
 */
public interface Product7<A, B, C, D, E, F, G> extends Product<$7>,
        Compound7<$7, A, B, C, D, E, F, G> {
     ...
     */
    default <R> R match(final Fn7<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? extends R> function) {
        return function.apply(_1(), _2(), _3(), _4(), _5(), _6(), _7());
    }

    // ----------------------------------------------------------
    //  PRODUCT-7.ASSIGNABLE
    // ----------------------------------------------------------

    /**
     * Assignable form of {@link Product7}.
     *
     * @param <A> type of the 1st slot.
     * @param <B> type of the 2nd slot.
     * @param <C> type of the 3rd slot.
     ...
     */
    interface Assignable<A, B, C, D, E, F, G, U extends Assignable<A, B, C, D, E, F, G, ?>>
            extends Product7<A, B, C, D, E, F, G>, Compound7.Assignable<A, B, C, D, E, F, G, U> {
    }
}
