...
/**
 * Declares a parametric slot at position 7 via an index-named accessor.
 * Slots are elementary shapes used to form compounded value structures.
 *
 * @param <N> type-level arity.
 * @param <G> type of slot value.
 */
public @Mixin interface Slot7<N extends $7, G> {

    /**
     * Returns the value of the 7th slot.
     */
    G _7();
    ...
    /**
     * Assignable form of {@link Slot7} by declaring
     * an index-named assignment operation.
     *
     * @param <G> type of  value to be assigned.
     * @param <R> type of result to be returned.
     */
    @Mixin interface Assignable<G, R extends Slot7<?, G>> {

        /**
         * Returns the result of assigning the given value to this slot.
         *
         * @param value to be assigned of type {@link G}.
