...
/**
 * A tuple of 8 heterogeneously typed components;
 * canonical representation of a {@link Product8}.
 *
 ...
 * @param <H> type of 8th component.
 */
public class Tuple8<A, B, C, D, E, F, G, H> extends Tuple.AbstractBase<$8>

        implements Product8.Assignable<A, B, C, D, E, F, G, H, Tuple8<A, B, C, D, E, F, G, H>>,

        NFunctor.Of8<A, B, C, D, E, F, G, H, Tuple8<?, ?, ?, ?, ?, ?, ?, ?>>,

        HList.Prependable<Tuple8<A, B, C, D, E, F, G, H>>,

        HList.Cell<A, Tuple7<B, C, D, E, F, G, H>>
{
    /**
     ...
     */
    public Tuple8(final A _1, final B _2, final C _3, final D _4, final E _5, final F _6, final G _7, final H _8) {
        this._1 = _1;
        this._2 = _2;
        this._3 = _3;
        this._4 = _4;
     ...
     */
    public Tuple8(final Product8<? extends A, ? extends B, ? extends C, ? extends D, ? extends E, ? extends F, ? extends G, ? extends H> product) {
        this._1 = product._1();
        this._2 = product._2();
        this._3 = product._3();
        this._4 = product._4();
     ...
     * Copy constructor.
     */
    public Tuple8(final Tuple8<A, B, C, D, E, F, G, H> tuple) {
        this._1 = tuple._1;
        this._2 = tuple._2;
        this._3 = tuple._3;
        this._4 = tuple._4;
     ...
     */
    @Override
    public final Tuple7<B, C, D, E, F, G, H> tail() {
     ...
     */
    @Override
    public final Cell<A, Cell<B, Cell<C, Cell<D, Cell<E, Cell<F, Cell<G, Single<H>>>>>>>> hlist() {
        return HList.of(_1, _2, _3, _4, _5, _6, _7, _8);
    }
     ...
     */
    @Override
    public final Tuple8<A, B, C, D, E, F, G, H> _1(final A a) {
        return Tuple.of(a, _2, _3, _4, _5, _6, _7, _8);
    }
     ...
     */
    @Override
    public final Tuple8<A, B, C, D, E, F, G, H> _2(final B b) {
        return Tuple.of(_1, b, _3, _4, _5, _6, _7, _8);
    }
     ...
     */
    @Override
    public final Tuple8<A, B, C, D, E, F, G, H> _3(final C c) {
        return Tuple.of(_1, _2, c, _4, _5, _6, _7, _8);
    }
     ...
     */
    @Override
    public final Tuple8<A, B, C, D, E, F, G, H> _4(final D d) {
        return Tuple.of(_1, _2, _3, d, _5, _6, _7, _8);
    }
     ...
     */
    @Override
    public final Tuple8<A, B, C, D, E, F, G, H> _5(final E e) {
        return Tuple.of(_1, _2, _3, _4, e, _6, _7, _8);
    }
     ...
     */
    @Override
    public final Tuple8<A, B, C, D, E, F, G, H> _6(final F f) {
        return Tuple.of(_1, _2, _3, _4, _5, f, _7, _8);
    }
     ...
     */
    @Override
    public final Tuple8<A, B, C, D, E, F, G, H> _7(final G g) {
        return Tuple.of(_1, _2, _3, _4, _5, _6, g, _8);
    }

    /**
     * Returns a tuple with the given value in the 8th component.
     *
     * @param h value of the 8th component.
     * @return new tuple.
     */
    @Override
    public final Tuple8<A, B, C, D, E, F, G, H> _8(final H h) {
     ...
     * @param <I>   type of value to be prepended.
     * @return new tuple of type {@link TupleN}.
     */
    @Override
    public final <I> TupleN<I, Tuple8<A, B, C, D, E, F, G, H>> prepend(final I value) {
        return new TupleN<>(value, this);
    }
     ...
     * @return new {@link Tuple8}<I, B, C, D, E, F, G, H>.
     */
    @Override
    public <I> Tuple8<I, B, C, D, E, F, G, H> map1(final Fn1<? super A, ? extends I> f1) {
        return Tuple.of(f1.apply(_1), _2, _3, _4, _5, _6, _7, _8);
    }
     ...
     * @return new {@link Tuple8}<A, J, C, D, E, F, G, H>.
     */
    @Override
    public <J> Tuple8<A, J, C, D, E, F, G, H> map2(final Fn1<? super B, ? extends J> f2) {
        return Tuple.of(_1, f2.apply(_2), _3, _4, _5, _6, _7, _8);
    }
     ...
     * @return new {@link Tuple8}<A, B, K, D, E, F, G, H>.
     */
    @Override
    public <K> Tuple8<A, B, K, D, E, F, G, H> map3(final Fn1<? super C, ? extends K> f3) {
        return Tuple.of(_1, _2, f3.apply(_3), _4, _5, _6, _7, _8);
    }
     ...
     * @return new {@link Tuple8}<A, B, C, L, E, F, G, H>.
     */
    @Override
    public <L> Tuple8<A, B, C, L, E, F, G, H> map4(final Fn1<? super D, ? extends L> f4) {
        return Tuple.of(_1, _2, _3, f4.apply(_4), _5, _6, _7, _8);
    }
     ...
     * @return new {@link Tuple8}<A, B, C, D, M, F, G, H>.
     */
    @Override
    public <M> Tuple8<A, B, C, D, M, F, G, H> map5(final Fn1<? super E, ? extends M> f5) {
        return Tuple.of(_1, _2, _3, _4, f5.apply(_5), _6, _7, _8);
    }
     ...
     * @return new {@link Tuple8}<A, B, C, D, E, N, G, H>.
     */
    @Override
    public <N> Tuple8<A, B, C, D, E, N, G, H> map6(final Fn1<? super F, ? extends N> f6) {
        return Tuple.of(_1, _2, _3, _4, _5, f6.apply(_6), _7, _8);
    }
     ...
     * @return new {@link Tuple8}<A, B, C, D, E, F, O, H>.
     */
    @Override
    public <O> Tuple8<A, B, C, D, E, F, O, H> map7(final Fn1<? super G, ? extends O> f7) {
        return Tuple.of(_1, _2, _3, _4, _5, _6, f7.apply(_7), _8);
    }

    /**
     * Returns a tuple with mapped 8th component {@code C -> K}
     * by applying the given function.
     *
     * @param f8 mapping function of the 8th component.
     * @return new {@link Tuple8}<A, B, C, D, E, F, G, P>.
     */
    @Override
    public <P> Tuple8<A, B, C, D, E, F, G, P> map8(final Fn1<? super H, ? extends P> f8) {
        return Tuple.of(_1, _2, _3, _4, _5, _6, _7, f8.apply(_8));
    }
     ...
     * @param f7 mapping function of the 7th component.
     * @param f8 mapping function of the 8th component.
     * @return new {@link Tuple8}<I, J, K, L, M, N, O, P>.
     */
    @Override
    public <I, J, K, L, M, N, O, P>
    Tuple8<I, J, K, L, M, N, O, P> map(final Fn1<? super A, ? extends I> f1,
                                       ...
                                       final Fn1<? super H, ? extends P> f8) {
        try {
            return Tuple.of(
                    f1.onApply(_1),
                    f2.onApply(_2),
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof final Product8<?, ?, ?, ?, ?, ?, ?, ?> that))
            return false;
