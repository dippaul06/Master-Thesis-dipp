...
/**
 * Magma {@code char} type companion.
 */
public enum C16 {
    ;
    /** Constant of the smallest representable value of {@code C16} type. */
    public static final char MIN = Character.MIN_VALUE + 1;

    /** Constant of the largest representable value of {@code C16} type. */
    public static final char MAX = Character.MAX_VALUE;

    /** Constant holding the » Not-a-Number (NaN) « value of {@code C16} type. */
    public static final char NaN = Character.MIN_VALUE;

    /** Determines whether the given value is the Not-a-Number (NaN) value. */
    public static boolean isNaN(final char value) { return C16.NaN == value; }

    // ----------------------------------------------------------

    /// FUNCTION CONSTRUCTION.

    /// Factory methods to construct {@code char} specialized functions
    /// from method references or lambda expressions see JLS §15.13, §15.27.

    /** Constructs a specialized {@code char -> R} function. */
    public static <R> To<R> to(final To<R> fn) { return fn; }

    /** Constructs a specialized {@code char -> byte} function. */
    public static ToI8 ToI8(final ToI8 fn) { return fn; }

    /** Constructs a specialized {@code char -> short} function. */
    public static ToI16 ToI16(final ToI16 fn) { return fn; }

    /** Constructs a specialized {@code char -> char} function. */
    public static ToC16 ToC16(final ToC16 fn) { return fn; }

    /** Constructs a specialized {@code char -> int} function. */
    public static ToI32 ToI32(final ToI32 fn) { return fn; }

    /** Constructs a specialized {@code char -> long} function. */
    public static ToI64 ToI64(final ToI64 fn) { return fn; }

    /** Constructs a specialized {@code char -> float} function. */
    public static ToF32 ToF32(final ToF32 fn) { return fn; }

    /** Constructs a specialized {@code char -> double} function. */
    public static ToF64 ToF64(final ToF64 fn) { return fn; }

    /** Constructs a specialized {@code char} predicate. */
    public static Predicate Predicate(final Predicate pd) { return pd; }

    /** Constructs a specialized {@code char} supplier. */
    public static Supplier Supplier(final Supplier sp) { return sp; }

    /** Constructs a specialized {@code char} consumer. */
    ...
    /**
     * Function that takes no argument and returns a {@code char} result.
     * <p>
     * Acts as a supplier of {@code char} values, and makes no guarantees
     * for invocations returning a new or different result.
     */
    @FunctionalInterface
    public interface Supplier extends $Fn0<Character> {
    ...
    /**
     * Consumer operation that takes a single {@code char} argument
     * and returns no value. Consumer operates via side effects.
     */
    @FunctionalInterface
    public interface Consumer extends $Fn1<Character, Unit> {

        /** The effect-less consumer. */
        Consumer empty = Const.empty;

        /**
         * Performs this operation with the given {@code char} argument.
         *
         * @param val consumer argument.
         */
        void onAccept(char val) throws Throwable;

        /**
         * Applies this consumer to the given {@code char} argument.
         *
         * @param val consumer argument.
         */
        default void accept(final char val) {
            try {
                onAccept(val);
            } catch (final Throwable ex) {
                Throw.sneaky(ex);
        ...
        enum Const implements Consumer {
            empty { public void onAccept(char val) { } }
        }
    }
    ...
    /**
     * Predicate (boolean-valued function) that takes a single {@code char} argument.
     */
    @FunctionalInterface
    public interface Predicate extends $Fn1<Character, Boolean> {
        ...
        /**
         * Evaluates this predicate with the given {@code char} argument.
         *
         * @param val predicate argument.
         * @return true iff this predicate is satisfied.
         * @throws Throwable permits any exception to be thrown.
         */
        boolean onEval(char val) throws Throwable;

        /**
         * Applies this predicate to the given {@code char} argument.
         *
         * @param val predicate argument.
         * @return true iff this predicate is satisfied.
         */
        default boolean eval(final char val) {
            try {
                return onEval(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
        ...
        enum Const implements Predicate {
            True  { public boolean onEval(char __) { return true;  } },
            False { public boolean onEval(char __) { return false; } }
        }
    }
    ...
    /**
     * Function that takes a single {@code char} argument
     * and returns a result of type {@code R}.
     *
     * @param <R> type of function result.
     */
    @FunctionalInterface
    public interface To<R> extends $Fn1<Character, R> {

        /**
         * Invokes this function with the given {@code char} argument.
         *
         * @param val function argument.
         * @return result of type {@code R}.
         * @throws Throwable permits any exception to be thrown.
         */
        R onApply(char val) throws Throwable;

        /**
         * Applies this function to the given {@code char} argument.
         *
         * @param val function argument.
         * @return result of type {@code R}.
         */
        default R apply(final char val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToBool extends $Fn1<Character, Boolean> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        boolean onApply(char val) throws Throwable;
         ...
         * @return {@code boolean} result.
         */
        default boolean apply(final char val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToI8 extends $Fn1<Character, Byte> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        byte onApply(char val) throws Throwable;
         ...
         * @return {@code byte} result.
         */
        default byte apply(final char val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToI16 extends $Fn1<Character, Short> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        short onApply(char val) throws Throwable;
         ...
         * @return {@code short} result.
         */
        default short apply(final char val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToC16 extends $Fn1<Character, Character> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        char onApply(char val) throws Throwable;
         ...
         * @return {@code char} result.
         */
        default char apply(final char val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToI32 extends $Fn1<Character, Integer> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        int onApply(char val) throws Throwable;
         ...
         * @return {@code int} result.
         */
        default int apply(final char val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToI64 extends $Fn1<Character, Long> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        long onApply(char val) throws Throwable;
         ...
         * @return {@code long} result.
         */
        default long apply(final char val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToF32 extends $Fn1<Character, Float> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        float onApply(char val) throws Throwable;
         ...
         * @return {@code float} result.
         */
        default float apply(final char val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToF64 extends $Fn1<Character, Double> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        double onApply(char val) throws Throwable;
         ...
         * @return {@code double} result.
         */
        default double apply(final char val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    public interface Traverser extends ITraverser<Character, Consumer> {

        // ----------------------------------------------------------
        //  C16.TRAVERSER.INDEXED
        // ----------------------------------------------------------
         ...
         */
        interface Indexed extends ITraverser.Indexed<Character, Consumer>, Traverser {
         ...
         */
        interface Duplex extends ITraverser.Duplex<Character, Consumer>, Traverser {

            // ----------------------------------------------------------
            //  C16.TRAVERSER.DUPLEX.INDEXED
            // ----------------------------------------------------------
             ...
             */
            interface Indexed extends ITraverser.Duplex.Indexed<Character, Consumer>,
         ...
         */
        @Override
        default java.util.Iterator<Character> iterator() {
            // Weak iterator contract...
            final class It implements java.util.Iterator<Character>, Consumer {
                private Character next;
                @Override public boolean hasNext() { return tryNext(this); }
                @Override public Character next() { return next; }
                @Override public void onAccept(final char next) {
                    this.next = next;
                }
            }
            return new It();
    ...
    */
    public interface Traversable extends Iterable<Character>, ITraversable<Consumer> {
     ...
     */
    public interface Flow<U extends IFlow<?, U>> extends IFlow<Character, U>,

            Traversable,

            // ----------------------------------------------------------

            Operation.Query.Membership.OfC16<U>,

            Operation.Query.Quantify.OfC16<U>,

            // ----------------------------------------------------------

            Operation.Fold.FoldLeft.OfC16<U>,

            Operation.Fold.Collect.OfC16<U>,

            // ----------------------------------------------------------

            Operation.Convert.ToArray.OfC16<U>,

            Operation.Convert.ToCollection.OfC16<U>
    {
        /**
         ...
         */
        @Override
        default boolean contains(final char val) {
         ...
         * the given predicate over the values {@code '∃(x) ∈ Flow.OfC16 P(x)'}.
         ...
         * of the predicate over the values {@code '∀(x) ∈ Flow.OfC16 P(x)'}.
         * The predicate is not evaluated for all values if it is not required
         ...
         * the negated predicate over the array {@code '∀(x) ∈ Flow.OfC16 ¬P(x)'}.
         * The predicate is not evaluated for all values if it is not required
         * to determine the result. If no values are present, the quantification
         * is said to be 'vacuously satisfied', and always true is returned,
         * independent of P(x).
        ...
        default <Z> Z foldLeft(final Z initial, final Fn1<Z, To<Z>> combiner) {
            ...
            final class Fold implements Consumer {
                ...
                @Override
                public void onAccept(final char value) throws Throwable {
        ...
        interface Producer<U extends IProducer<?, U>> extends Flow<U>,
                ...
                IProducer<Character, U>,

                // ----------------------------------------------------------

                Transform.Peek.OfC16<U>,

                Transform.Filter.OfC16<U>,

                // ----------------------------------------------------------

                Transmute.Map.OfC16<U>,

                Transmute.FlatMap.OfC16<U> {
        }
    }
     ...
     */
    public static Option some(final char value) {
     ...
     * @return optional value.
     */
    public static Option when(final boolean condition, final char value) {
     ...
     */
    public interface Option extends IOption<Character>,

            Operation.Access.Value.OfC16<IOption<?>>,

            Operation.Transmute.PolyMap.OfC16<IOption<?>>,

            Operation.Transmute.PolyFlatMap.OfC16<IOption<?>>,
            ...
            Flow.Producer<IOption<?>>
    {
         ...
         * @return match result.
         */
        <R> R match(Fn1<? super Character, ? extends R> some,
                    Fn0<? extends R> none);
         ...
         */
        <X extends Throwable> char orElseThrow(magma.exa.value.Lazy<? extends X> exception) throws X;
        ...
        final class Some implements Option {
             ...
             */
            @Override
            public <R> R match(final Fn1<? super Character, ? extends R> some,
             ...
             */
            @Override
            public char orElse(final Supplier other) {
             ...
             */
            @Override
            public <X extends Throwable> char orElseThrow(final magma.exa.value.Lazy<? extends X> exception) {
        ...
        enum None implements Option {
             ...
             */
            @Override
            public <X extends Throwable> char orElseThrow(final magma.exa.value.Lazy<? extends X> exception) throws X {
    ...
    /**
     * A lazy evaluated {@code char} value.
     */
    public interface Lazy extends Supplier {
        ...
        static Lazy of(final Supplier thunk) {
            ...
            final class LazyBox implements Lazy {
                ...
                private char value;
                @Override
                public char onApply() throws Throwable {
                    if (!initialized) {
                        synchronized (this) {
                            if (!initialized) {
                                value = thunk.apply();
    ...
    public enum Relation implements To<Predicate> {
        EQ { @Override public Predicate onApply(final char val) { return x -> x == val; } },
        NE { @Override public Predicate onApply(final char val) { return x -> x != val; } },
        GT { @Override public Predicate onApply(final char val) { return x -> x >  val; } },
        GE { @Override public Predicate onApply(final char val) { return x -> x >= val; } },
        LT { @Override public Predicate onApply(final char val) { return x -> x <  val; } },
        LE { @Override public Predicate onApply(final char val) { return x -> x <= val; } }
    }


    // ----------------------------------------------------------

    public static Predicate equal        (final char val) { return Relation.EQ.apply(val); }
    public static Predicate notEqual     (final char val) { return Relation.NE.apply(val); }
    public static Predicate greaterThan  (final char val) { return Relation.GT.apply(val); }
    public static Predicate greaterEqual (final char val) { return Relation.GE.apply(val); }
    public static Predicate lessThan     (final char val) { return Relation.LT.apply(val); }
    public static Predicate lessEqual    (final char val) { return Relation.LE.apply(val); }

    // ----------------------------------------------------------

    public static Predicate any(final char... ary) {
        return (ary.length != 0) ? x -> Array.anyMatch(ary, equal(x)) : Predicate.False;
    }
    public static Predicate all(final char... ary) {
