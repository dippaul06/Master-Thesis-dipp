...
/**
 * Magma {@code float} type companion.
 */
public enum F32 {
    ;
    /** Constant of the smallest representable value of {@code F32} type. */
    public static final float MIN = Float.MIN_VALUE + 1;

    /** Constant of the largest representable value of {@code F32} type. */
    public static final float MAX = Float.MAX_VALUE;

    /** Constant holding the » Not-a-Number (NaN) « value of {@code F32} type. */
    public static final float NaN = Float.MIN_VALUE;

    /** Determines whether the given value is the Not-a-Number (NaN) value. */
    public static boolean isNaN(final float value) { return F32.NaN == value; }

    // ----------------------------------------------------------

    /// FUNCTION CONSTRUCTION.

    /// Factory methods to construct {@code float} specialized functions
    /// from method references or lambda expressions see JLS §15.13, §15.27.

    /** Constructs a specialized {@code float -> R} function. */
    public static <R> To<R> to(final To<R> fn) { return fn; }

    /** Constructs a specialized {@code float -> byte} function. */
    public static ToI8 ToI8(final ToI8 fn) { return fn; }

    /** Constructs a specialized {@code float -> short} function. */
    public static ToI16 ToI16(final ToI16 fn) { return fn; }

    /** Constructs a specialized {@code float -> char} function. */
    public static ToC16 ToC16(final ToC16 fn) { return fn; }

    /** Constructs a specialized {@code float -> int} function. */
    public static ToI32 ToI32(final ToI32 fn) { return fn; }

    /** Constructs a specialized {@code float -> long} function. */
    public static ToI64 ToI64(final ToI64 fn) { return fn; }

    /** Constructs a specialized {@code float -> float} function. */
    public static ToF32 ToF32(final ToF32 fn) { return fn; }

    /** Constructs a specialized {@code float -> double} function. */
    public static ToF64 ToF64(final ToF64 fn) { return fn; }

    /** Constructs a specialized {@code float} predicate. */
    public static Predicate Predicate(final Predicate pd) { return pd; }

    /** Constructs a specialized {@code float} supplier. */
    public static Supplier Supplier(final Supplier sp) { return sp; }

    /** Constructs a specialized {@code float} consumer. */
    ...
    /**
     * Function that takes no argument and returns a {@code float} result.
     * <p>
     * Acts as a supplier of {@code float} values, and makes no guarantees
     * for invocations returning a new or different result.
     */
    @FunctionalInterface
    public interface Supplier extends $Fn0<Float> {
         ...
         */
        float onApply() throws Throwable;
    ...
    /**
     * Consumer operation that takes a single {@code float} argument
     * and returns no value. Consumer operates via side effects.
     */
    @FunctionalInterface
    public interface Consumer extends $Fn1<Float, Unit> {

        /** The effect-less consumer. */
        Consumer empty = Const.empty;

        /**
         * Performs this operation with the given {@code float} argument.
         *
         * @param val consumer argument.
         */
        void onAccept(float val) throws Throwable;

        /**
         * Applies this consumer to the given {@code float} argument.
         *
         * @param val consumer argument.
         */
        default void accept(final float val) {
            try {
                onAccept(val);
            } catch (final Throwable ex) {
                Throw.sneaky(ex);
        ...
        enum Const implements Consumer {
            empty { public void onAccept(float val) { } }
        }
    }
    ...
    /**
     * Predicate (boolean-valued function) that takes a single {@code float} argument.
     */
    @FunctionalInterface
    public interface Predicate extends $Fn1<Float, Boolean> {
        ...
        /**
         * Evaluates this predicate with the given {@code float} argument.
         *
         * @param val predicate argument.
         * @return true iff this predicate is satisfied.
         * @throws Throwable permits any exception to be thrown.
         */
        boolean onEval(float val) throws Throwable;

        /**
         * Applies this predicate to the given {@code float} argument.
         *
         * @param val predicate argument.
         * @return true iff this predicate is satisfied.
         */
        default boolean eval(final float val) {
            try {
                return onEval(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
        ...
        enum Const implements Predicate {
            True  { public boolean onEval(float __) { return true;  } },
            False { public boolean onEval(float __) { return false; } }
        }
    }
    ...
    /**
     * Function that takes a single {@code float} argument
     * and returns a result of type {@code R}.
     *
     * @param <R> type of function result.
     */
    @FunctionalInterface
    public interface To<R> extends $Fn1<Float, R> {

        /**
         * Invokes this function with the given {@code float} argument.
         *
         * @param val function argument.
         * @return result of type {@code R}.
         * @throws Throwable permits any exception to be thrown.
         */
        R onApply(float val) throws Throwable;

        /**
         * Applies this function to the given {@code float} argument.
         *
         * @param val function argument.
         * @return result of type {@code R}.
         */
        default R apply(final float val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToBool extends $Fn1<Float, Boolean> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        boolean onApply(float val) throws Throwable;
         ...
         * @return {@code boolean} result.
         */
        default boolean apply(final float val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToI8 extends $Fn1<Float, Byte> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        byte onApply(float val) throws Throwable;
         ...
         * @return {@code byte} result.
         */
        default byte apply(final float val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToI16 extends $Fn1<Float, Short> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        short onApply(float val) throws Throwable;
         ...
         * @return {@code short} result.
         */
        default short apply(final float val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToC16 extends $Fn1<Float, Character> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        char onApply(float val) throws Throwable;
         ...
         * @return {@code char} result.
         */
        default char apply(final float val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToI32 extends $Fn1<Float, Integer> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        int onApply(float val) throws Throwable;
         ...
         * @return {@code int} result.
         */
        default int apply(final float val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToI64 extends $Fn1<Float, Long> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        long onApply(float val) throws Throwable;
         ...
         * @return {@code long} result.
         */
        default long apply(final float val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToF32 extends $Fn1<Float, Float> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        float onApply(float val) throws Throwable;
         ...
         * @return {@code float} result.
         */
        default float apply(final float val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    @FunctionalInterface
    public interface ToF64 extends $Fn1<Float, Double> {
         ...
         * @throws Throwable permits any exception to be thrown.
         */
        double onApply(float val) throws Throwable;
         ...
         * @return {@code double} result.
         */
        default double apply(final float val) {
            try {
                return onApply(val);
            } catch (final Throwable ex) {
                return Throw.sneaky(ex);
     ...
     */
    public interface Traverser extends ITraverser<Float, Consumer> {

        // ----------------------------------------------------------
        //  F32.TRAVERSER.INDEXED
        // ----------------------------------------------------------
         ...
         */
        interface Indexed extends ITraverser.Indexed<Float, Consumer>, Traverser {
         ...
         */
        interface Duplex extends ITraverser.Duplex<Float, Consumer>, Traverser {

            // ----------------------------------------------------------
            //  F32.TRAVERSER.DUPLEX.INDEXED
            // ----------------------------------------------------------
             ...
             */
            interface Indexed extends ITraverser.Duplex.Indexed<Float, Consumer>,
         ...
         */
        @Override
        default java.util.Iterator<Float> iterator() {
            // Weak iterator contract...
            final class It implements java.util.Iterator<Float>, Consumer {
                private Float next;
                @Override public boolean hasNext() { return tryNext(this); }
                @Override public Float next() { return next; }
                @Override public void onAccept(final float next) {
                    this.next = next;
                }
            }
            return new It();
    ...
    */
    public interface Traversable extends Iterable<Float>, ITraversable<Consumer> {
     ...
     */
    public interface Flow<U extends IFlow<?, U>> extends IFlow<Float, U>,

            Traversable,

            // ----------------------------------------------------------

            Operation.Query.Membership.OfF32<U>,

            Operation.Query.Quantify.OfF32<U>,

            // ----------------------------------------------------------

            Operation.Fold.FoldLeft.OfF32<U>,

            Operation.Fold.Collect.OfF32<U>,

            // ----------------------------------------------------------

            Operation.Convert.ToArray.OfF32<U>,

            Operation.Convert.ToCollection.OfF32<U>
    {
        /**
         ...
         */
        @Override
        default boolean contains(final float val) {
         ...
         * the given predicate over the values {@code '∃(x) ∈ Flow.OfF32 P(x)'}.
         ...
         * of the predicate over the values {@code '∀(x) ∈ Flow.OfF32 P(x)'}.
         * The predicate is not evaluated for all values if it is not required
         ...
         * the negated predicate over the array {@code '∀(x) ∈ Flow.OfF32 ¬P(x)'}.
         * The predicate is not evaluated for all values if it is not required
         * to determine the result. If no values are present, the quantification
         * is said to be 'vacuously satisfied', and always true is returned,
         * independent of P(x).
        ...
        default <Z> Z foldLeft(final Z initial, final Fn1<Z, To<Z>> combiner) {
            ...
            final class Fold implements Consumer {
                ...
                @Override
                public void onAccept(final float value) throws Throwable {
        ...
        interface Producer<U extends IProducer<?, U>> extends Flow<U>,
                ...
                Transform.Peek.OfF32<U>,

                Transform.Filter.OfF32<U>,

                // ----------------------------------------------------------

                Transmute.Map.OfF32<U>,

                Transmute.FlatMap.OfF32<U> {
        }
    }
     ...
     */
    public static Option some(final float value) {
     ...
     * @return optional value.
     */
    public static Option when(final boolean condition, final float value) {
     ...
     */
    public interface Option extends IOption<Float>,

            Operation.Access.Value.OfF32<IOption<?>>,

            Operation.Transmute.PolyMap.OfF32<IOption<?>>,

            Operation.Transmute.PolyFlatMap.OfF32<IOption<?>>,
            ...
            Flow.Producer<IOption<?>>
    {
         ...
         * @return match result.
         */
        <R> R match(Fn1<? super Float, ? extends R> some,
                    Fn0<? extends R> none);
         ...
         * @return optional {@code float}.
         */
        Option flatMapF32(To<? extends Iterable<Float>> mapper);
         ...
         * Returns either some present value or throws an exception.
         */
        default float get() { return value(); }
         ...
         */
        <X extends Throwable> float orElseThrow(magma.exa.value.Lazy<? extends X> exception) throws X;
        ...
        final class Some implements Option {
             ...
             */
            @Override
            public <R> R match(final Fn1<? super Float, ? extends R> some,
             ...
             */
            @Override
            public float orElse(final Supplier other) {
             ...
             */
            @Override
            public <X extends Throwable> float orElseThrow(final magma.exa.value.Lazy<? extends X> exception) {
             ...
             */
            @Override
            public Option mapF32(final ToF32 mapper) {
             ...
             */
            @Override
            public Option flatMapF32(final To<? extends Iterable<Float>> mapper) {
                final var itr = mapper.apply(value);
                // Strict defensive on data being passed.
                if (null != itr) {
                    final var it = itr.iterator();
        ...
        enum None implements Option {
             ...
             */
            @Override
            public <X extends Throwable> float orElseThrow(final magma.exa.value.Lazy<? extends X> exception) throws X {
    ...
    /**
     * A lazy evaluated {@code float} value.
     */
    public interface Lazy extends Supplier {
        ...
        static Lazy of(final Supplier thunk) {
            ...
            final class LazyBox implements Lazy {
                ...
                private float value;
                @Override
                public float onApply() throws Throwable {
                    if (!initialized) {
                        synchronized (this) {
                            if (!initialized) {
                                value = thunk.apply();
    ...
    public enum Relation implements To<Predicate> {
        EQ { @Override public Predicate onApply(final float val) { return x -> x == val; } },
        NE { @Override public Predicate onApply(final float val) { return x -> x != val; } },
        GT { @Override public Predicate onApply(final float val) { return x -> x >  val; } },
        GE { @Override public Predicate onApply(final float val) { return x -> x >= val; } },
        LT { @Override public Predicate onApply(final float val) { return x -> x <  val; } },
        LE { @Override public Predicate onApply(final float val) { return x -> x <= val; } }
    }


    // ----------------------------------------------------------

    public static Predicate equal        (final float val) { return Relation.EQ.apply(val); }
    public static Predicate notEqual     (final float val) { return Relation.NE.apply(val); }
    public static Predicate greaterThan  (final float val) { return Relation.GT.apply(val); }
    public static Predicate greaterEqual (final float val) { return Relation.GE.apply(val); }
    public static Predicate lessThan     (final float val) { return Relation.LT.apply(val); }
    public static Predicate lessEqual    (final float val) { return Relation.LE.apply(val); }

    // ----------------------------------------------------------

    public static Predicate any(final float... ary) {
        return (ary.length != 0) ? x -> Array.anyMatch(ary, equal(x)) : Predicate.False;
    }
    public static Predicate all(final float... ary) {
